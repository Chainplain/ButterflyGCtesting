...
class socket_manager(QObject):
    ...
    def start_calibration_command(self): # this is used for new calibration
        self. TCP_write_thread.acquire()
        try:       
            send_bytes = self.pack_bytes("#") 
            self. mysocket.sendto(send_bytes, (self.my_remote_IP, self. my_remote_port_name))
        finally:
            self. TCP_write_thread.release()
...
class Ui_MainWindow(QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RecTlable.setText(_translate("MainWindow", "Record time length(sec)"))
