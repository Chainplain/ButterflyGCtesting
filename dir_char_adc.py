...
ser = serial.Serial('COM3', 300000)  # Replace 'COM1' with the appropriate port name and 9600 with the desired baud rate
Frame_data = ""
read_length = 100
...
File_name = "diradcVal" +current_day + current_time +".csv"
